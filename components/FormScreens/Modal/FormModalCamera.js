...
import { TouchableOpacity, Modal, StyleSheet, View, Text, Alert, SafeAreaView, CameraRoll, StatusBar, Dimensions } from 'react-native';
...
class FormModalCamera extends Component {
	...
	snap = async () => {
	  	if (this.camera) {
	    	...
	    	this.props.handleImage([this.props.identifier],saveResult);
	  	}
