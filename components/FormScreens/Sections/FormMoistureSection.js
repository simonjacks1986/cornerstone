...
class FormMoistureSection extends Component {
  ...
  _pickImage = async () => {
	...
	render(){
		const { values, iteration, handleChange, setWhichGrade, setModalVisible, handlePicker, data1, setWhichImage, handleImage, removeImage } = this.props;
		return(
        ...
        />
          ...
          <View style={styles.photoRow}>
            <Text 
              ...
              onPress={() => {
                this.setWhichImage('simImage' + iteration);
            ...
            { values.photos['simImage' + iteration] && 
            <Text 
              style={styles.photoButton}
              onPress={() => {
                  this.setWhichImage('simImage' + iteration);
